            ...
            {loggedIn && (entregas.length === 0 ? (
                ...
                entregas.map((e, i) => (
                    <div key={e.id || i} style={mCard}>
                        <div style={{ color: '#00e676', fontWeight: 'bold', fontSize: '12px' }}>PARADA {(tarefaAtual && Number.isFinite(Number(tarefaAtual.ordem_logistica)) && Number(tarefaAtual.ordem_logistica) > 0) ? Number(tarefaAtual.ordem_logistica) : (i + 1)}</div>
